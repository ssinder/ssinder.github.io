...
const App = (function() {
    ...
    function performSearch() {
        ...
        try {
            ...
            UIManager.hideLoading();
            // 传入网络可视化回调函数
            UIManager.showResultsWithNetwork(results, showNetworkForProtein);
     ...
     */
    function showNetworkForProtein(protein, interactions) {
        console.log('[DEBUG] 显示网络图, protein:', protein.gene_names || protein.g, '互作数量:', interactions.length);
        NetworkVisualizer.show(protein, interactions);
    ...
    return {
        start,
        performSearch,
        showNetworkForProtein
    };
})();

// 将showNetworkForProtein暴露到全局作用域，供onclick调用
window.showNetworkForProtein = App.showNetworkForProtein;
